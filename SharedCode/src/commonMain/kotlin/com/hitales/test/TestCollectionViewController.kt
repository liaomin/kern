...
//                size.set((itemWidth * random()).toFloat(),(itemWidth * random()).toFloat() )
        ...
        (collectionView.layout as DefaultCollectionViewLayout).minimumInterItemSpacing = 10f
        (collectionView.layout as DefaultCollectionViewLayout).minimumLineSpacing = 10f
